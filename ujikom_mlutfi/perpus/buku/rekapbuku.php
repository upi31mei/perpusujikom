...
<form action="index.php?page=printbuku" method="post" name="postform"><center>

  <p align="center"><font size="5"><b>Pencarian Data Berdasarkan Periode Tanggal</b></font></p>
  <p align="center"><font size="3">Tanggal Pertama Input Data Buku : <b><?php echo "$a[tglinput]"; ?></b></font></p>
